...
/*
  ...
  // Move actuators Forward to initial position
 */  
  digitalWrite(IN1, LOW);
...
void stopActuators(int ActuatorSpeed, int duration) {
  // stop actuators 
...
void loop() {
        ...
        moveActuatorsToInitialPosition(150, 2000); // Adjust duration as needed
        Serial.println(F("Actuators in initial position."));
        stopActuators(150,1000);
